...
/// A reusable widget that allows the user to change the background theme.
class RestaurantThemeButton extends ConsumerWidget {
  const RestaurantThemeButton({super.key});
