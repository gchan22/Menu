...
1. [x] Create a widget directory with a file that creates a widget that designs the background called backdrop have it a gradiant background going from light blue to green

2. [x] Create a screens directory with a file called restaurant call backdrop in widget for background which has a column starting with a typeable text box labeled Restaurant Name and underneath have another typeable text box called Slogan 

3. [x] Create a new file in screen called menu call backdrop from widget with column hard code a row textbox with a food icon with text Chicken next to it, under that have another row with food icon and text Beef next to it, under that a row with food icon with Pork text next to it, under that have a beverage icon and text Soda next to it
...
11. [x] Make a new file in screens called finalizedResturant have the resturant screen when click the button start eating go to finalizedResturant screen have the finalized Resturant screen have a column that has textbox that says the Restaurant name entered and under that have another text box that says the slogan entered and under that have a button that says Start Dining when pressed goes to the menu screen
...
96. [x] In cart screen if the same item increase a number before the item name 
saying the amount of the item that was added and if only 1 item that say 1 before 
...
106. [x] In menu file in screen folder break up code into reusable widgets
